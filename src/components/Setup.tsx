        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          <div>
            ...
            <input
              ...
              type="password"
              required
              className="block w-full px-3 py-2 mt-1 placeholder-gray-400 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-cyan-500 focus:border-cyan-500 sm:text-sm"
              placeholder="sk-..."
              value={apiKey}
